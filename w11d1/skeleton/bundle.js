...
console.log(_util_api_util__WEBPACK_IMPORTED_MODULE_4__["fetchSearchGiphys"]);
...
var fetchSearchGiphys = function fetchSearchGiphys(searchTerm) {
  return $.ajax({
    method: 'get',
    url: "http://api.giphy.com/v1/gifs/search?q=".concat(searchTerm, "&api_key=cCvezBSLyU0TqAOrSP894SOA0yekJB09&limit=2")
  });
};
